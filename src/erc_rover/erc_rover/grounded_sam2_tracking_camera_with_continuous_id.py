...
# from final_pipeline.final_pipeline.grounded_sam_2.utils.common_utils import CommonUtils
from grounded_sam2.utils.mask_dictionary_model import MaskDictionaryModel, ObjectInfo
# from final_pipeline.grounded_sam_2.utils.track_utils import sample_points_from_masks
# from final_pipeline.grounded_sam_2.utils.video_utils import create_video_from_images
...
class IncrementalObjectTracker:
    ...
    def add_image(self, image_np: np.ndarray):
        ...
        return annotated_frame, self.last_mask_dict
...
import cv2
import torch
# from Grounded_SAM2.utils.common_utils import CommonUtils
